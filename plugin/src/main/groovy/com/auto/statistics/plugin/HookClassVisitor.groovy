...
import com.auto.statistics.config.HookConfig
 ...
 * @param name 表示方法名，在 ASM 中 “visitMethod” 方法会处理（构造方法、静态代码块、私有方法、受保护的方法、公有方法、native类型方法）。
 ...
 */
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        Logger.info("11111 Hooked method: ${name}${desc} in ${mClassName}\n")
